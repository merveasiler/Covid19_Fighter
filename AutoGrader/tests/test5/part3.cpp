// g++ -ansi -pedantic evaluator/common.cpp submission/Particle.cpp submission/Wall.cpp submission/CurvyWall.cpp submission/Cell.cpp submission/MicroOrganism.cpp submission/Squadratic.cpp submission/Tissue.cpp tests/test5/part3.cpp -o tests/test5/part3
...
int tester(const char* cellFile) {
	...
	int result = 0;
	int cellID = 1;	// id of the cell which will be used to connect the microorganism in this test case
	...
	mo->React();
	try {
		Squadratic& child = ((Squadratic*)mo)->GetChild(-3, 1, -1, 3);
		result = 3;
		child.React();
		try {
			Squadratic& grandchild = ((Squadratic*)mo)->GetChild(-3, -1, -1, 1);
			result = 5;
		} catch (exception& e) {}
	} catch (exception& e) {}
