// g++ -ansi -pedantic evaluator/common.cpp submission/Particle.cpp submission/Wall.cpp submission/CurvyWall.cpp submission/Cell.cpp submission/MicroOrganism.cpp submission/Circular.cpp submission/Tissue.cpp tests/test5/part6.cpp -o tests/test5/part6
...
int tester(const char* cellFile) {
	...
	int result = 0;
	int cellID = 9;	// id of the cell which will be used to connect the microorganism in this test case
