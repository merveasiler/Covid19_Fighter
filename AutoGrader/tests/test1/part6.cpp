// g++ -ansi -pedantic evaluator/common.cpp submission/Particle.cpp submission/Wall.cpp submission/CurvyWall.cpp tests/test1/part6.cpp -o tests/test1/part6
...
int tester() {
	...
	if (qWall->IsContinuousLinear(*pWall))
		result = 0;
	else
		result = 2;
