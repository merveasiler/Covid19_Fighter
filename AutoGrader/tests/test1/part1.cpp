// g++ -ansi -pedantic evaluator/common.cpp submission/Particle.cpp submission/Wall.cpp tests/test1/part1.cpp -o tests/test1/part1
...
int tester() {
	...
	Particle* q1 = new Particle(-1,2);
	Particle* q2 = new Particle(-3,2);
