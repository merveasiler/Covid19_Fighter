// g++ -ansi -pedantic evaluator/common.cpp submission/Particle.cpp submission/Wall.cpp submission/CurvyWall.cpp submission/Cell.cpp submission/MicroOrganism.cpp submission/Circular.cpp submission/Tissue.cpp tests/test4/part7.cpp -o tests/test4/part7
...
int tester() {
	...
	for (int i=0; i < p.size(); i++)
		walls.push_back(new CurvyWall(*p[i], *p[(i+1)%p.size()], Particle(-1,-1)));
