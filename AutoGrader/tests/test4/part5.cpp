// g++ -ansi -pedantic evaluator/common.cpp submission/Particle.cpp submission/Wall.cpp submission/CurvyWall.cpp submission/Cell.cpp submission/MicroOrganism.cpp submission/Squadratic.cpp submission/Tissue.cpp tests/test4/part5.cpp -o tests/test4/part5
...
int tester() {
	...
	p.push_back(new Particle(-10, -0.416));		// vertex-2
	p.push_back(new Particle(-7, -7.83));		// vertex-3
	p.push_back(new Particle(-4, -0.416));		// vertex-4
