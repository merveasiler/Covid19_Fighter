// g++ -ansi -pedantic evaluator/common.cpp submission/Particle.cpp submission/Wall.cpp submission/CurvyWall.cpp tests/test2/part4.cpp -o tests/test2/part4
...
int tester() {
	...
	Particle* q2 = new Particle(1,-4.16);
	...
	try {
		...
		if (newWall->GetInitialParticle() == *p1 && newWall->GetFinalParticle() == *q2 && ((CurvyWall*)newWall)->GetCenter() == *p3)
			result = 2;
		else
			result = 0;
		delete newWall;
