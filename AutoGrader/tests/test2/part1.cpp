// g++ -ansi -pedantic evaluator/common.cpp submission/Particle.cpp submission/Wall.cpp tests/test2/part1.cpp -o tests/test2/part1
...
int tester() {
	...
	Particle* q2 = new Particle(11,13);
	...
	try {
		...
		if (newWall->GetInitialParticle() == *p1 && newWall->GetFinalParticle() == *q2)
			result = 2;
		else if (newWall->GetInitialParticle() == *q2 && newWall->GetFinalParticle() == *p1)
			result = 2;
		else
			result = 0;
		delete newWall;
