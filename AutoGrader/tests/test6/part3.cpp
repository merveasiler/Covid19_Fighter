// g++ -ansi -pedantic evaluator/common.cpp submission/Particle.cpp submission/Wall.cpp submission/CurvyWall.cpp submission/Cell.cpp submission/MicroOrganism.cpp submission/NucleoBase.cpp submission/Triangular.cpp submission/Tissue.cpp tests/test6/part3.cpp -o tests/test6/part3
...
int tester() {
	...
	string stringChain1 = "";
	NucleoBase* RNA1 = new NucleoBase(stringChain1, NULL);
	MicroOrganism* mo1 = new Triangular(10, walls, *RNA1);
	string stringChain2 = "";
