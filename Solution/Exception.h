...
class ApplePearException : public exception {
   ...
   /* This exception class is used in the summation of Wall and CurvyWall objects
...
class DeadCellException : public exception {
    ...
    /* This exception class is used while trying to reach a dead cell in some
       tissue.
     */
...
class NotBornChildException : public exception {
    ...
    /* This exception class is used while trying to reach a non-existing child
